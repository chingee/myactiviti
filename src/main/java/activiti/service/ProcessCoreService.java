...
public class ProcessCoreService {  
	...
	protected static Log log = LogFactory.getLog(ProcessCoreService.class);
...
//        }  
    ...
    public void backProcess(String taskId, String activityId, Map<String, Object> variables) {  
        if (StringUtils.isEmpty(activityId)) {  
            throw new ActivitiRunTimeException("驳回目标节点ID为空！");  
        }  
...
//        }  
    ...
    private TaskEntity findTaskById(String taskId) {  
        TaskEntity task = (TaskEntity) taskService.createTaskQuery().taskId(  
                taskId).singleResult();  
        if (task == null) {  
            throw new ActivitiRunTimeException("任务实例未找到!");  
        }  
        return task;  
    }  
    ...
    private ProcessInstance findProcessInstanceByTaskId(String taskId){  
        ...
        if (processInstance == null) {  
            throw new ActivitiRunTimeException("流程实例未找到!");  
        }  
    ...
    private ProcessDefinitionEntity findProcessDefinitionEntityByTaskId(String taskId) {  
        ...
        if (processDefinition == null) {  
            throw new ActivitiRunTimeException("流程定义未找到!");  
        }  
